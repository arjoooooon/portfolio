            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 animate-box">
                        <div data-aos='fade-up' class="progress-wrap">
                            <h3>Photoshop</h3>
                            <div class="progress">
                    ...
                    <div class="col-md-6 animate-box">
                        <div data-aos='fade-up' class="progress-wrap">
                            <h3>jQuery</h3>
                            <div class="progress">
                                <div class="progress-bar color-2" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                    <span>60%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 animate-box">
                        <div data-aos='fade-up' class="progress-wrap">
                            <h3>HTML5</h3>
                            <div class="progress">
                                <div class="progress-bar color-3" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
                                    <span>85%</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div data-aos='fade-up' class="col-md-4 text-center d-flex">
