        ...
        <div className={styles.container}>
            ...
            <div className={styles.descriptionContainer}>
                ...
                <div className={styles.descriptionText}>
                    ...
                    className={styles.link} rel="noopener noreferrer">blog</a>! This year I am dedicating time to bring this project into the
                    mainstream. Do watch this space for updates.<br/><br/>
